...
```
poetry run python -m opencole.inference_launcher.gpt4_augmented_baselines --tester (sdxl|sd3|deepfloyd|dalle3|flux1_dev|flux1_schnell) --output_dir <OUTPUT_DIR>
```
